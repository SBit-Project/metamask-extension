# Metamask with SBIT support

This is an alpha version of Metamask with SBIT support

To use Web3 in SBIT Dapps, use `window.sbit` as your Web3 provider instead of `window.ethereum`

See [Releases](https://github.com/SBit-Project/metamask-extension/releases) for tags/releases with SBIT support

See [Janus](https://github.com/SBit-Project/janus) for our Web3 compatible API layer

See [sbit-ethers-wrapper](https://github.com/SBit-Project/sbit-ethers) for client-side transaction signing
