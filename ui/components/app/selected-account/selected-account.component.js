...
class SelectedAccount extends Component {
  ...
  render() {
    ...
    const { selectedIdentity, sbitAddress, isSbitAddressShow } = this.props;
        ...
        >
          <button
            ...
            onClick={() => {
              ...
              copyToClipboard(isSbitAddressShow ? sbitAddress : checksummedAddress);
            }}
          >
            ...
            <div className="selected-account__address">
              {isSbitAddressShow ? shortenAddress(sbitAddress) : shortenAddress(checksummedAddress)}
