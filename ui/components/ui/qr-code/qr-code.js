...
function QrCodeView(props) {
  const { Qr, warning, sbitAddressBook, isSbitAddressShowCheck } = props;
    ...
    <div className="qr-code">
      ...
      >
        <div
          ...
          onClick={() => {
            handleCopy(isSbitAddressShowCheck ? sbitAddressBook[data] : toChecksumHexAddress(data));
          }}
        >
          <div className="qr-code__address">{isSbitAddressShowCheck ? sbitAddressBook[data] : toChecksumHexAddress(data)}</div>
