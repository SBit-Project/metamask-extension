      ...
      >
        ...
        <div className="send__select-recipient-wrapper__group-item__content">
          <div className="send__select-recipient-wrapper__group-item__title">
            {name ? <Confusable input={name} /> : isSbitAddressShowCheck ? sbitAddressBook[address] : ellipsify(address)}
          </div>
          {name && (
            <div className="send__select-recipient-wrapper__group-item__subtitle">
              {isSbitAddressShowCheck ? sbitAddressBook[address] : ellipsify(address)}
            </div>
          )}
        </div>
      </div>
    ...
    return (
      <div className="send__select-recipient-wrapper__list">
        ...
        <RecipientGroup
          label={t('myAccounts')}
          items={ownedAccounts}
          sbitAddressBook={sbitAddressBook}
          isSbitAddressShowCheck={isSbitAddressShowCheck}
