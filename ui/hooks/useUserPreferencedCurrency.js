...
import { PRIMARY, SECONDARY, ETH, SBIT } from '../helpers/constants/common';
...
export function useUserPreferencedCurrency(type, opts = {}) {
  ...
  if (
    ...
    // Display ETH
    currency = nativeCurrency || SBIT;
    numberOfDecimals = opts.numberOfDecimals || opts.ethNumberOfDecimals || 8; // SBIT: or 6?
  } else if (
    (type === SECONDARY && useNativeCurrencyAsPrimaryCurrency) ||
    (type === PRIMARY && !useNativeCurrencyAsPrimaryCurrency)
  ) {
