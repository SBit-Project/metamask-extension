...
export default function reduceMetamask(state = {}, action) {
  ...
  switch (action.type) {
    ...
    case actionConstants.UPDATE_SBIT_BALANCE: {
      return {
        ...metamaskState,
        ...action.value,
      }
...
export function getSbitBalances(state) {
  return state.metamask.sbitBalances;
}

export function getSbitAddress(state, address) {
  return state.metamask.sbitAddresses[address];
}

export function getSbitAddressBook(state) {
  return state.metamask.sbitAddresses;
}

export function isSbitAddressShow(state) {
  return state.metamask.preferences.isSbitAddressShow;
}
