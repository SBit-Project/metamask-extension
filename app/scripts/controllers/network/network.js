...
if (process.env.IN_TEST === 'true') {
  ...
  defaultProviderConfigOpts = { type: NETWORK_TYPE_RPC, chainId: SBIT_TESTNET_CHAIN_ID, rpcUrl: SBIT_TESTNET_RPC_URL, nickname: SBIT_TESTNET };
  // defaultProviderConfigOpts = { type: NETWORK_TYPE_RPC, chainId: SBIT_REGTEST_CHAIN_ID, rpcUrl: SBIT_REGTEST_RPC_URL };
} else {
  defaultProviderConfigOpts = { type: MAINNET, chainId: MAINNET_CHAIN_ID };
  defaultProviderConfigOpts = { type: NETWORK_TYPE_RPC, chainId: SBIT_TESTNET_CHAIN_ID, rpcUrl: SBIT_TESTNET_RPC_URL, nickname: SBIT_TESTNET };
  // defaultProviderConfigOpts = { type: NETWORK_TYPE_RPC, chainId: SBIT_MAINNET_CHAIN_ID, rpcUrl: SBIT_MAINNET_RPC_URL };
}
...
export default class NetworkController extends EventEmitter {
  ...
  lookupNetwork() {
    ...
    const isInfura = INFURA_PROVIDER_TYPES.includes(type) && !SBIT_PROVIDER_TYPES.includes(type);
  ...
  setRpcTarget(rpcUrl, chainId, ticker = 'SBIT', nickname = '', rpcPrefs) {
    assert.ok(
  ...
  async setProviderType(type) {
    ...
    if (SBIT_PROVIDER_TYPES.includes(type)) {
      type = NETWORK_TYPE_RPC;
